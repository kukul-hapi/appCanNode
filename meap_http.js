...
Request.prototype.attach = function (field, file, filename, conType) {
    ...
    var formBinary = Buffer.alloc(item.form, 'utf-8');
    var rn = Buffer.alloc("\r\n", 'utf-8');
...
Request.prototype.field = function (name, val) {
    ...
    this.attachments.push(item);
    var contentBinary = Buffer.alloc(item.form, 'utf-8');
...
Request.prototype.writeAttachments = function () {
    ...
    var items = this.attachments
        ...
        , length = this.attachmentsize + Buffer.alloc(MULTIPART_END, "utf-8").length;
